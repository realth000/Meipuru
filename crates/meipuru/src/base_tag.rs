use crate::{binding::MeipuruBaseTagBuffer, buffer_like::BufferWalker};
...
impl TryFrom<*mut MeipuruBaseTagBuffer> for BaseTag {
    type Error = String;

    fn try_from(value: *mut MeipuruBaseTagBuffer) -> Result<Self, Self::Error> {
        if value.is_null() {
